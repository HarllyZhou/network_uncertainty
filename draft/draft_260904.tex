...
\begin{align*}
    ...
    [i_{i,t}]: \quad &\mathbb{E}_{i,t}\left[\lambda^{f}_{i,t}p_{K,t} - \mathcal{M}_{t,t+1} J'(\tilde{k}_{i, t+1})\left(\mathbbm{1}_{\Xi^1_{i,t} \cup \Xi^2_{i,t}} + \eta_i a_i(1-\tau_{i,t+1})p_{i,t+1}\frac{y_{i,t+1}/k_{i,t+1}}{p_{K,t+1}}\mathbbm{1}_{\Xi^2_{i,t}}\right)\right] = 0,
\end{align*}
