...
\end{align}
Here $b^h_{i,t}$ denotes the household's holdings of firm $i$'s debt, $e_{i,t} \in [0,1]$ is the share of firm $i$'s equity holdings which, in equilibrium, is equal to 1 for all $i$'s and $t$'s, $q_{i,t}$ is the price of firm $i$'s equity, and $\tilde{r}_{i,t}$ is the realized return on firm $i$'s debt. It is defined by
