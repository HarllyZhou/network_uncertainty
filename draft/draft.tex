...
\end{align*}
Therefore, the price-cost ratio increases with the productivity shock $\sigma_{i,t-1}$ if and only if the conditional probability of repayment is larger than $\frac{1}{2}$.
