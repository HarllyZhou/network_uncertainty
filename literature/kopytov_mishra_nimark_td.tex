...
\paragraph{Results} 1) Higher uncerntainty leads producers to purchase from more stable supplers despite potentially higher prices. The resulting reorganization of the network tends to reduce macroeconomic volatility, but at the cost of a decline in aggregate output. 2) More productive and stable firms have higher Domar weights in equilibrium.
